...
class MyUserManager(BaseUserManager):
	""" A custom Mnageer to deal with emails as unique identifer """
...
class User(AbstractBaseUser,PermissionsMixin):
	...
	default = True,
	help_text = ugettext_lazy('Designates whether this user should be treated as active. Uselect this instead of deleting accounts')
